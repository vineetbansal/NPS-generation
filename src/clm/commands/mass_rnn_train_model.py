...
def add_args(parser):
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="Whether to include masses in the collate function",
    )
...
def mass_rnn_train_model(
    ...
    for epoch in range(max_epochs):
        for batch_no, batch in tqdm(enumerate(loader), total=len(loader)):
            ...
            # writer.add_scalar("Validation Loss", validation_loss.item(), batch_no)
...
def main(args):
    mass_rnn_train_model(
        ...
        include_masses=args.include_masses,
    )
